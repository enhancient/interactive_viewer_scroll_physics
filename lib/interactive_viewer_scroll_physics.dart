...
typedef InteractiveViewerScrollPhysicsWidgetBuilder = Widget Function(BuildContext context, Quad viewport);
...
class InteractiveViewerScrollPhysics extends StatefulWidget {
  ...
  static Vector3 getNearestPointInside(Vector3 point, Quad quad) {
    ...
    final List<Vector3> closestPoints = <Vector3>[
      InteractiveViewerScrollPhysics.getNearestPointOnLine(point, quad.point0, quad.point1),
      InteractiveViewerScrollPhysics.getNearestPointOnLine(point, quad.point1, quad.point2),
      InteractiveViewerScrollPhysics.getNearestPointOnLine(point, quad.point2, quad.point3),
      InteractiveViewerScrollPhysics.getNearestPointOnLine(point, quad.point3, quad.point0),
    ];
  ...
  @override
  State<InteractiveViewerScrollPhysics> createState() => _InteractiveViewerScrollPhysicsState();
}

class _InteractiveViewerScrollPhysicsState extends State<InteractiveViewerScrollPhysics> with TickerProviderStateMixin {
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return InteractiveViewerScrollPhysics.getAxisAlignedBoundingBox(boundariesRotated);
}
...
Offset _exceedsBy(Quad boundary, Quad viewport) {
  ...
  for (final Vector3 point in viewportPoints) {
    final Vector3 pointInside = InteractiveViewerScrollPhysics.getNearestPointInside(point, boundary);
